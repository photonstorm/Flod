...
package neoart.flod.deltamusic {
  ...
  public final class D2Player extends AmigaPlayer {
    ...
    override protected function loader(stream:ByteArray):void {
      var i:int = 0, id:String, j:int, len:int, offsets:Vector.<int>, position:int, row:AmigaRow, sample:D2Sample, step:AmigaStep, value:int;
      ...
      for (; i < 4; ++i) {
        data[int(i + 4)] = stream.readUnsignedShort();
