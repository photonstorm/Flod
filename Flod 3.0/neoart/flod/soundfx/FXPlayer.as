...
package neoart.flod.soundfx {
  ...
  public final class FXPlayer extends AmigaPlayer {
    ...
    override public function process():void {
      var chan:AmigaChannel, index:int, period:int, row:AmigaRow, sample:AmigaSample, test:int, value:int, voice:FXVoice = voices[0];
          ...
          if (voice.stepSpeed) {
            ...
            switch (voice.effect) {
              ...
              case 7:   //step up
                ...
                test = version > SOUNDFX_18 ? voice.last : voice.period;
